...
def MLP(n_channels = 6):
  eeg_input = Input(shape=(206, n_channels))
  model = Flatten()(eeg_input)
  model = Dense(128, activation = 'relu')(model)
  model = Dropout(0.5)(model)
  model = Dense(1, activation = 'sigmoid')(model)

  return Model(eeg_input, model, name = 'MLP')

def SimpleConv1D(activation = 'relu', pad = 'same', n_channels = 6):
  eeg_input = Input(shape=(206, n_channels))
  ...
  return Model(eeg_input, model, name='simpleconv')
