...
#
"""
Script to train and save a SepConv1D model for single-trial cross-subject P300 detection
"""
import argparse
import sys
import numpy as np
...
def save_cross_subject_model(data, labels, modelpath, n_filters = 32):
    """
    Trains and saves SepConv1D
    """
    n_sub = data.shape[0]
...
def main():
    ...
    try:
        ...
        save_cross_subject_model(data, labels, args.modelpath, n_filters = args.n_filters)
