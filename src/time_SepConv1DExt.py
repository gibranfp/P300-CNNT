...
def evaluate_subject_model(X_train, y_train, X_valid, y_valid, X_test, y_test, timepath, n_filters = 32):
    ...
    model = SepConv1DExt(Chans = n_channels, Samples = n_samples, Filters = n_filters)
    ...
    df.to_csv(timepath + 'SepConv1DExt_' + str(n_filters) + 'F_times.csv', encoding='utf-8')
...
def main():
    ...
    try:
        ...
        parser.add_argument("--n_filters", type=int, default = 32,
                            help="Number of filters to use for SepConv1DExt")
        ...
        evaluate_subject_model(X_train, y_train, X_valid, y_valid, X_test, y_test, args.timepath, n_filters = args.n_filters)
