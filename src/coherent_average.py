...
#
"""
Script to evaluate the P300-CNNT architecture for coherent-average subject-dependent P300 detection using cross-validation
"""
import argparse
import sys
import numpy as np
...
def main():
    ...
    try:
        ...
        parser = argparse.ArgumentParser(
            description="Evaluates coherent-average subject-dependent P300 detection using cross-validation")
        ...
        parser.add_argument("--n_trials", type=int, default=2,
                            help="Number of trials to coherently average")
