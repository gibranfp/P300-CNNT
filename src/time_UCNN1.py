...
#
"""
Script to evaluate the UCNN1 architecture (Lawhern et al., 2018) for single-trial subject-dependent P300 detection 
"""
import argparse
import sys
import numpy as np
...
def evaluate_subject_model(X_train, y_train, X_valid, y_valid, X_test, y_test, timepath):
    ...
    df.to_csv(timepath + 'UCNN1_times.csv', encoding='utf-8')
