...
#
"""
Script to evaluate a modified CNN3 architecture for single-trial cross-subject P300 detection
"""
import argparse
import sys
import numpy as np
...
def evaluate_cross_subject_model(data, labels, modelpath):
    """
    Trains and evaluates the modified CNN3 for each subject in the P300 Speller database
