...
#
"""
Script to evaluate a Fully-Connected Neural Network (FCNN) architecture for single-trial subject-dependent P300 detection
"""
import argparse
import sys
import numpy as np
...
def evaluate_subject_models(data, labels, modelpath, subject):
    """
    Trains and evaluates the FCNN architecture for each subject in the P300 Speller database
